...
const s = StyleSheet.create({
  ...
  kicker: { color: colors.kicker, fontFamily: font.bodyBold, fontSize: 11, marginTop: 14, paddingHorizontal: space.xl },
  ...
  featTxt: { color: '#000', fontFamily: font.bodyBold, fontSize: 9,},
