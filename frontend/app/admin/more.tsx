...
import {
  ...
  ShoppingBag, Receipt, Sparkles, MessageSquare, Settings, ChevronRight, Layers, Link2 } from 'lucide-react-native';
...
const SECTIONS: { title: string; items: Item[] }[] = [
    ...
    ] },
  {
    ...
    items: [
      ...
      { key: 'shares',   label: 'Share Links',     helper: 'Active public share links · hard delete', icon: Link2, route: '/admin/share-links', iconColor: colors.info },
    ] },
  {
    title: 'Business',
    items: [
